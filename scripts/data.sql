...
VALUES
    ...
    ('2023-03-05 20:15:00', '2027-12-11', 2, '2027-12-14', 'PENDING', 1, 1, 120);
...
VALUES 
    ...
    ('2023-04-10', '2023-04-15', 13),
    ('2027-12-10', '2027-12-15', 13);

INSERT INTO accommodations_price_list (accommodation_id, price_list_id)
VALUES
    (1, 73), (1, 74), (1, 75), (1, 76), (1, 77), (1, 78), (2, 79), (5, 80), (7, 81),
    (15, 82), (1, 83), (2, 84), (10, 85), (12, 86), (1, 87);

INSERT INTO availability (start_date, end_date)
VALUES 
    ('2023-05-09', '2023-05-14'), ('2023-05-09', '2023-05-14'), ('2027-12-10', '2027-12-15');
